...
| Phase 1 | 完成 | core/store/importer/search/embedder、§-2.2 + §-2.3 共 14 个一等 adapter、本地 hybrid RAG |
...
| Phase 4 | 计划中 | §-1.5 PR-6 session extractor（Episode → Fact/Preference/Skill/Feedback LLM 蒸馏）、memory MCP convention、Agent Memory Interchange Format |
