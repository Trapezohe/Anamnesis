...
pub const REGISTRY: &[CuratedModel] = &[
    ...
    CuratedModel {
        ...
        description: "Smallest local model. Old machines, embedded use, or thin clients.",
        query_prefix: None,
        doc_prefix: None,
        is_local: true,
        is_default: false,
    ...
    CuratedModel {
        ...
        approx_size_mb: 600,
        languages: "100+",
        description: "Heavy multilingual model. Best CN/EN mixed quality and long-doc handling.",
        query_prefix: None,
        doc_prefix: None,
        is_local: true,
        is_default: false,
